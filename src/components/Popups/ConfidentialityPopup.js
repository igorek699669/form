...
import {toggleConfidentialityPopupIsOpened} from '../../store/reducers/formReducer'
import SimpleBar from 'simplebar-react'
import 'simplebar/dist/simplebar.min.css'
import {AiOutlineClose} from 'react-icons/ai'

export const ConfidentialityPopup = ({isOpened}) => {
    const dispatch = useDispatch()
    const handleButtonClick = () => {
        dispatch(toggleConfidentialityPopupIsOpened(false, null))
    }
    return (
        <Popup className={'confidentiality-popup'} isOpened={isOpened}>
            <AiOutlineClose className={'confidentiality-popup__close'} color={'#2F80ED'} size={'19px'}
                            onClick={handleButtonClick}/>
            <div className="confidentiality-popup__header-text">Политика конфиденциальности</div>
            <div className="confidentiality-popup__text">
                <SimpleBar>
                    ...
                    данных, обеспечивающих их доступность в сети интернет по сетевому адресу httpsː//thismywebsite·com;
                    ...
                    определяемому Пользователю веб-сайта httpsː//thismywebsite·com;
                    ...
                    материалам, содержащимся на веб-сайте httpsː//thismywebsite·com; уточнение деталей заказа.
                    ...
                    privacy@thismywebsite·com с пометкой «Отказ от уведомлений о новых продуктах и услугах и специальных
                    предложениях».
                    ...
                    httpsː//thismywebsite·com. Заполняя соответствующие формы и/или отправляя свои персональные данные
                    ...
                    электронной почты на электронный адрес Оператора privacy@thismywebsite·com с пометкой «Отзыв
